...
use Doctrine\ORM\Mapping as ORM;
    ...
    {
    use \Customize\Entity\ProductTrait, \Plugin\ProductDisplayRank4\Entity\ProductTrait;
        ...
        public function _calc()
        {
            if (!$this->_calc) {
                ...
                foreach ($this->getProductClasses() as $ProductClass) {
					...
					// ▼sale_limit
					$this->sale_limits[] = $ProductClass->getSaleLimit();
	
					// ▼delivery_duration_id
					$this->delivery_duration_ids[] = $ProductClass->getDeliveryDuration();
		 ...
		 * @return integer
		 */
		public function getSaleLimitMin()
		{
			$this->_calc();
	
			return min($this->sale_limits);
		}
		/**
		 * ▼Get SaleLimit max
		 *
		 * @return integer
		 */
		public function getSaleLimitMax()
		{
			$this->_calc();
	
			return max($this->sale_limits);
		}
		//▼getDeliveryDuration min
		public function getDeliveryDurationMin()
		{
			$this->_calc();
	
			return min($this->delivery_duration_ids);
		}
		//▼getDeliveryDate max
		public function getDeliveryDurationMax()
		{
			$this->_calc();
	
			return max($this->delivery_duration_ids);
		}
         ...
         * @var string|null
         *
         * @ORM\Column(name="seo_author", type="text", nullable=true)
         */
        private $seo_author;
         ...
         * @var string|null
         *
         * @ORM\Column(name="seo_keyword", type="text", nullable=true)
         */
        private $seo_keyword;
         ...
         * @var string|null
         *
         * @ORM\Column(name="seo_meta_robots", type="text", nullable=true)
         */
        private $seo_meta_robots;

        /** ▼seo_meta_tags
         * @var string|null
         *
         * @ORM\Column(name="seo_meta_tags", type="text", nullable=true)
         */
        private $seo_meta_tags;
         ...
         * @var boolean
         *
         * @ORM\Column(name="option_class", type="decimal", nullable=true)
         */
         ...
         * @var \DateTime
         *
         * @ORM\Column(name="endsell_date", type="datetimetz", nullable=true)
         */
        private $endsell_date;
		/**
         * @var boolean
         *
         * @ORM\Column(name="arrival_check", type="boolean", options={"default":false})
         */
        private $arrival_check;
		/**
         * @var boolean
         *
         * @ORM\Column(name="endsell_check", type="boolean", options={"default":false})
         */
        private $endsell_check;
         ...
         * Set seoAuthor.
         *
         * @param string|null $seoAuthor
         *
         * @return Product
         */
        public function setSeoAuthor($seoAuthor = null)
        {
            $this->seo_author = $seoAuthor;
         ...
         * @return Product
         */
        public function setSeoKeyword($seoKeyword = null)
        {
         ...
         * Set seoMetaRobots.
         *
         * @param string|null $seoMetaRobots
         *
         * @return Product
         */
        public function setSeoMetaRobots($seoMetaRobots = null)
        {
            $this->seo_meta_robots = $seoMetaRobots;
         ...
         * @return string|null
         */
        public function getSeoMetaRobots()
        {
            return $this->seo_meta_robots;
        }

        /** ▼
         * Set seoMetaTags.
         *
         * @param string|null $seoMetaTags
         *
         * @return Product
         */
        public function setSeoMetaTags($seoMetaTags = null)
        {
            $this->seo_meta_tags = $seoMetaTags;
         ...
         * Set endsellDate.
         *
         * @param string|null $endsellDate
         *
         * @return Product
         */
        public function setEndsellDate($endsellDate = null)
        {
            $this->endsell_date = $endsellDate;
         ...
         * @return string|null
         */
        public function getEndsellDate()
        {
            return $this->endsell_date;
        }
		/**
         * Set arrivalCheck.
         *
         * @param string|null $arrivalCheck
         *
         * @return Product
         */
        public function setArrivalCheck($arrivalCheck)
        {
            $this->arrival_check = $arrivalCheck;
         ...
         * @return string|null
         */
        public function getArrivalCheck()
        {
            return $this->arrival_check;
        }
		/**
         * Set endsellCheck.
         *
         * @param string|null $endsellCheck
         *
         * @return Product
         */
        public function setEndsellCheck($endsellCheck)
        {
            $this->endsell_check = $endsellCheck;
         ...
         * @return string|null
         */
        public function getEndsellCheck()
        {
            return $this->endsell_check;
        }
    }
